...
const nav = document.querySelector('.box-buttons');
...
meuCatalogo.addEventListener('click', function () {

    mostrarTudo(menuOptions);
...
document.querySelector('a[href=".top"]').addEventListener('click', function (event) {
    ...
    document.querySelector('.box-buttons').style.display = 'none';
});